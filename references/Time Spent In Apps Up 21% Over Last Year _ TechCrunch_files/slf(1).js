...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+document.referrer+catmanduLogger()+catmandu_integration_mcc_m(aolTacRef(), document.referrer, '/search.*q=([^&]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='AAEQJ/greentech|BADUXtag/android|AAFEEdroid-razr|AAFEHgalaxy-nexus|AAESYipad-app|CEFDYhone|AAEMDplaystation|AAADNtechcrunchit.com|AEAJWpitches.techcrunch|AEJOBcrunchboard|AEADNtechcrunch|AEAJWcrunchbase|AEAEAmobilecrunch|AEPELcrunchgear|GEADNnotes|AEAJWtechcrunch50|KAADN.tv|AAFIXsocialnetwork:share:facebook:read|TAECM|TAECI:facebook|UAFILgoogleplus|UAECKlifestream|UAEUMtwitter|UAEWTfacebook:like|[AFIQok:recommend|UAFIWstumbleupon';
var ANAXLSL='';
var ANCB1=0;
var ANCB3=0;
var ANRD='';
